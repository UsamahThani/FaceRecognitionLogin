...
?>
                <head>
                    ...
                    <link rel="icon" type="image/png" sizes="16x16" href="images/icn2.png">
													...
													if(!mysqli_num_rows($query) > 0 )
														...
														{				
                                                            ...
                                                            <?php 
																			...
																			{
																			?>
                                                            <td> <button type="button" class="btn btn-info"><span class="fa fa-bars" aria-hidden="true"></span> In Order</button></td>
                                                            <?php 
																			  }
																			   if($status=="in process")
																			 { ?>
                                                            <td> <button type="button" class="btn btn-warning"><span class="fa fa-cog fa-spin" aria-hidden="true"></span> Process</button></td>
                                                            <?php
																				}
																			if($status=="closed")
																				{
