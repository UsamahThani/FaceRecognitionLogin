...
if (isset($_GET['username'])) {
    $username = mysqli_real_escape_string($db, $_GET['username']); // Sanitize the input
    $loginquery ="SELECT u_id FROM users WHERE username='$username'"; //selecting matching records
    ...
    if ($result) {
        ...
        if ($row) {
            ...
            // Example: $_SESSION['user_id'] = null; or redirect to error page
        }
    }
}
?>
...
<body class="home">
    ...
    <header id="header" class="header-scroll top-header headrom">
        <nav class="navbar navbar-dark">
            <div class="container">
                ...
                <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/logo0.png" alt="" width="18%"> </a>
                <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                    <ul class="nav navbar-nav">
						...
						if(empty($_SESSION["user_id"])) // if user is not login
							{
								echo '<li class="nav-item"><a href="http://127.0.0.1:5000/login" class="nav-link active">Login</a> </li>
    ...
    <section class="hero bg-image" data-image-src="images/img/background2.jpg">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                <h1>Dine-In & Take-Out </h1>
                ...
                <div class="steps">
                    ...
                    <div class="step-item step3">
                        ...
                        <h4><span style="color:white;">3. </span>Dine In or Take 0ut</h4>
                    </div>
        ...
        <div class="container">
                ...
                <div class="row how-it-works-solution">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                        <div class="step step-3">
                            ...
                            <h3><h3>Pick Up at Counter</h3>
								<p>Collect your food and enjoy your meal!</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12 text-center">
                    <p class="pay-info">Cash or Paypal</p>
                </div>
            </div>
        </div>
    </section>
